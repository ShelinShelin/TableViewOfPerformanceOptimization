...
- (void)layoutCalculate {
    ...
    switch (_item.images.count) {
        ...
        case 2:
        case 3:
            imagesSize = CGSizeMake(SCREEN_WIDTH - 2 * MARGIN, IMAGE_SIZE + MARGIN);
            break;
        case 4:
        case 5:
        case 6:
            imagesSize = CGSizeMake(SCREEN_WIDTH - 2 * MARGIN, IMAGE_SIZE * 2 + MARGIN * 3);
            break;
        case 7:
        case 8:
        case 9:
            imagesSize = CGSizeMake(SCREEN_WIDTH - 2 * MARGIN, IMAGE_SIZE * 3 + MARGIN * 3);
            break;
        default:
            break;
    }
    ...
    //tool bar layot
    _toolBarLayout = CGRectMake(MARGIN, CGRectGetMaxY(_imagesLayout) + MARGIN, SCREEN_WIDTH - 2 * MARGIN, 35);
